...
<body>
  <canvas id="canvas"></canvas>
    ...
    <div class="content-container">
        ...
        <h1 class="name">Bhop <img class="verified-icon" src="verified.png" alt="Verified"></h1>
        <p class="description">Hi 👋, I cheat in a block game.</p>
        <style> body { background-image: url('darkvideo.gif'); } </style>
        <!-- links -->
        <div class="links">
            <a href="https://github.com/FishyPlayZZ" target="_blank" class="link-btn"><i class="fab fa-github"></i></a>
    ...
    <audio src="example.mp3" id="my_audio" loop="loop"></audio>
    <div class="transparent-button" onclick="music();">
        <a href="#" id="play-audio-button">
            <img src="audio2.png" alt="" class="button-image">
...
.content-container {
    ...
    justify-content: center;
    height: 100vh;
  background-color: url("japan-blur.png");
}
